...
rem cscript //nologo For-Loop-vs-Lexical-Scope-Stress.js
...
rem For-Loop-vs-Lexical-Scope-Stress.py
...
rem powershell .\For-Loop-vs-Lexical-Scope-Stress.ps1

rem powershell .\Fib20-and-Fact20.ps1
